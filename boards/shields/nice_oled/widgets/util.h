...
#define LVGL_BACKGROUND                                                        \
  IS_ENABLED(CONFIG_NICE_OLED_WIDGET_INVERTED) ? lv_color_black()              \
                                               : lv_color_white()
#define LVGL_FOREGROUND                                                        \
  IS_ENABLED(CONFIG_NICE_OLED_WIDGET_INVERTED) ? lv_color_white()              \
                                               : lv_color_black()
...
#define CONFIG_NICE_OLED_SPLIT_TOTAL_DEVICES                                   \
  (1 + CONFIG_ZMK_SPLIT_BLE_CENTRAL_PERIPHERALS)
